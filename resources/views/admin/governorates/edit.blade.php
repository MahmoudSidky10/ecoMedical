...
@section('action' , "governorates/$item->id")
@section('nav')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url("admin/")}}">  {{trans('language.home')}}</a></li>
        <li class="breadcrumb-item"><a href="{{url("admin/governorates")}}">  {{trans('language.governorates')}}</a>
        </li>
...
@section('form-groups')
    @includeIf('admin.components.form.edit.select', ['label' => trans("language.countries"),'name'=>'country_id', 'items'=> $countries , 'icon' => 'fa fa-list',])
    ...
    @includeIf('admin.components.form.edit.text', ['required' => 'required','icon' => 'fa fa-user','label' => trans('language.delivery_cost'),'name'=>'delivery_cost', 'placeholder'=>trans('language.delivery_cost' ),'valid'=>trans('language.vaildation')])
