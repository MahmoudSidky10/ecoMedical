...
@section('form-groups')
    ...
    @includeIf('admin.components.form.add.text', ['icon' => 'fa fa-user','label' => trans('language.section_id'),'name'=>'section_id', 'placeholder'=>trans('language.section_id' ),'valid'=>trans('language.vaildation')])
