...
@section('action' , "templates/$item->id")
@section('nav')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url("admin/")}}">  {{trans('language.home')}}</a></li>
        <li class="breadcrumb-item"><a href="{{url("admin/templates")}}">  {{trans('language.templates')}}</a></li>
...
@section('form-groups')
    ...
    @includeIf('admin.components.form.edit.text', ['icon' => 'fa fa-user','label' => trans('language.section_id'),'name'=>'section_id', 'placeholder'=>trans('language.section_id' ),'valid'=>trans('language.vaildation')])
