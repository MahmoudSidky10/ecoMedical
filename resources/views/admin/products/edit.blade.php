...
@section('form-groups')
    ...
    <div class="form-group">
        <label>{{trans("language.brands")}}</label>
        <div class="input-group">
            <div class="input-group-prepend">
                <span class="input-group-text"><i class='fa fa-list'></i></span>
            </div>
            <select class="form-control " name="brand_id">
                ...
                @foreach($brands as $brand)
                    <option @if($brand->id == $item->brand_id) selected
    ...
    @includeIf('admin.components.form.edit.textarea', ['icon' => 'fa fa-user','label' => trans('language.description'),'name'=>'description', 'placeholder'=>trans('language.description' ),'valid'=>trans('language.vaildation')])
